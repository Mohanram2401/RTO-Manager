...
session_start();
    ...
    $u_id=$_SESSION['u_id'];
        ...
        $result=mysqli_query($conn,"SELECT * FROM l_updat where aadhar_no='$u_id' ");
		...
		if (!$result) {
		 $message = "you have not applied for license";
...
?>
	...
	<link rel="stylesheet" type="text/css" href="../css/license_stat.css">
</head>
<body>
